...
4. docs/设计落地约束洞察.md（涉及输入法 APP、MasterGo、组件库、视觉设计 Skill、设计规范、C2D 或视觉审查输入时读取）
5. docs/输出模板.md
6. prompts/视觉洞察主Prompt.md

然后基于我提供的 PRD、关键路径、链路截图、竞品材料、品牌规范、历史 UI 问题、设计规范 / 组件库 / 视觉设计 Skill 规则，输出视觉洞察报告。
```
